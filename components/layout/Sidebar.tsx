...
const ROLE_LABEL: Record<string, { label: string; color: string }> = {
  ...
  MANAGER:  { label: "매니저", color: "bg-violet-100 text-violet-700" },
  MEMBER:   { label: "멤버",   color: "bg-blue-100 text-blue-700" },
  GUEST:    { label: "게스트", color: "bg-gray-100 text-gray-500" },
};
...
export function Sidebar() {
  ...
  return (
    <>
      ...
      >
        <div className="flex justify-end p-2 border-b border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-900">
