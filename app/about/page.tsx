...
import { CnuStaticCube } from "@/components/custom/cnu-rotating-cube";
...
const ACTIVITY_SECTIONS = [
  ...
  },
  {
    ...
    title: "멘토링",
    description:
      "프로젝트의 기획과 개발 과정에 도움이 될 수 있는 조언과 피드백을 제공합니다. \nSW 마에스트로, 기업 부트캠프 등 외부 개발자 프로그램을 준비하는 학회원들을 위한 경험과 정보도 함께 공유합니다.",
  },
  {
    id: "networking",
    title: "네트워킹",
...
export default function AboutPage() {
  return (
    <main className="font-cnu-body min-h-[calc(100svh-4rem)] bg-white text-[#14231b]">
      <section className="relative min-h-[240px] overflow-hidden bg-[#14231b] text-white sm:min-h-[280px]">
        <div
          aria-hidden="true"
        ...
        >
          <ScrollReveal
            ...
            delay={120}
            distance={12}
            className="absolute top-[66px] right-[15%] hidden text-right text-[clamp(82px,7vw,128px)] leading-[0.8] font-bold text-white/[0.035] select-none xl:block"
          >
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1756px] px-5 pt-9 sm:px-10 lg:pr-8 lg:pl-20 2xl:pr-0 2xl:pl-[72px]">
          <div className="grid lg:grid-cols-[289px_minmax(0,1fr)] lg:gap-x-[106px]">
            <section className="relative lg:col-start-2">
              <ScrollReveal eager className="sm:pr-36 lg:pr-44">
                <h1 className="font-cnu-body pt-8 pr-20 text-[42px] leading-[1.08] font-bold tracking-[0] sm:pr-0 sm:text-6xl">
                  소개
                </h1>
                <p className="mt-5 w-full pr-2 text-lg text-white/65 sm:text-xl">
        ...
        <div className="grid lg:grid-cols-[289px_minmax(0,1fr)] lg:gap-x-[106px]">
          ...
          <div className="max-w-[1060px] lg:col-start-2">
            {INFO_GROUPS.map((group, groupIndex) => (
              ...
              >
                <div className="border-b border-[#14231b]/25 py-4 sm:py-5">
                  <h2 className="text-xl font-semibold tracking-[0] sm:text-2xl">
                    {group.title}
                  </h2>
                </div>
                ...
                {group.items.map((section) => (
                  ...
                  >
                    <h3 className="text-xl leading-7 font-semibold tracking-[0] text-[#40795b] sm:text-[22px]">
                      {section.title}
                    </h3>
                    <p className="whitespace-pre-line text-[15px] leading-7 text-[#14231b]/68 sm:col-start-2 sm:text-base sm:leading-7 lg:text-[17px] lg:leading-8">
                      {section.description}
                    </p>
                  </section>
                ))}
            ...
            >
              ...
              <div>
                <div className="hidden grid-cols-[110px_repeat(3,minmax(0,1fr))] gap-x-6 border-b border-[#14231b]/15 py-4 text-sm font-medium text-[#14231b]/55 sm:grid">
                  <span>연도</span>
                ...
                {EXECUTIVES.map((executive) => (
                  ...
                  >
                    <p className="col-span-3 text-lg font-semibold tabular-nums sm:col-span-1 sm:text-xl">
                      {executive.year}
                    </p>
                    {EXECUTIVE_ROLES.map((role) => (
                      <div key={role.key} className="min-w-0">
                        <p className="mb-1 text-xs font-medium text-[#14231b]/50 sm:hidden">
                          {role.label}
                        </p>
